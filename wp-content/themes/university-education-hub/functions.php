...
function university_education_hub_header_style() {
    if ( get_header_image() ) :
    $custom_header = "
        .headerbox{
        ...
        wp_add_inline_style( 'university-education-hub-child-style', $custom_header );
    endif;
}
add_action( 'wp_enqueue_scripts', 'university_education_hub_header_style' );

if ( ! defined( 'ELEARNING_EDUCATION_PRO_THEME_URL' ) ) {
    define( 'ELEARNING_EDUCATION_PRO_THEME_URL', 'https://www.themespride.com/themes/education-hub-wordpress-theme/' );
}
...
if ( ! defined( 'ELEARNING_EDUCATION_FREE_THEME_URL' ) ) {
	define( 'ELEARNING_EDUCATION_FREE_THEME_URL', 'https://www.themespride.com/themes/free-university-wordpress-theme/' );
}
if ( ! defined( 'ELEARNING_EDUCATION_DEMO_THEME_URL' ) ) {
	define( 'ELEARNING_EDUCATION_DEMO_THEME_URL', 'https://www.themespride.com/university-education-hub-pro/' );
}
if ( ! defined( 'ELEARNING_EDUCATION_DOCS_THEME_URL' ) ) {
    define( 'ELEARNING_EDUCATION_DOCS_THEME_URL', 'https://www.themespride.com/demo/docs/university-education-hub-lite/' );
}
if ( ! defined( 'ELEARNING_EDUCATION_DOCS_URL' ) ) {
	define( 'ELEARNING_EDUCATION_DOCS_URL', esc_url('https://www.themespride.com/demo/docs/university-education-hub-lite/'));
}
...
define('UNIVERSITY_EDUCATION_CREDIT',__('https://www.themespride.com/themes/free-university-wordpress-theme/','university-education-hub') );
if ( ! function_exists( 'university_education_credit' ) ) {
    function university_education_credit(){
        echo "<a href=".esc_url(UNIVERSITY_EDUCATION_CREDIT)." target='_blank'>".esc_html__('University Education Hub WordPress Theme ','university-education-hub')."</a>";
    }
}
